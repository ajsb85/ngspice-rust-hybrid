...
extern char* get_rust_message(void);
extern void free_rust_message(char*);

int main(int argc, char **argv)
{
    hello_from_rust();
    char *rust_msg = get_rust_message();
    if (rust_msg) {
        printf("Message from Rust FFI: %s\n", rust_msg);
        free_rust_message(rust_msg);
    }
